    ...
    <div className="buildDatabase">
      <form action="">
        <div className="inputData">
          ...
          <input
            ...
            id="type"
            type="text"
            placeholder="type of your model"
          />
        </div>
      ...
      <form action="">
        <div className="operations">
          <label htmlFor="Subpiece">Subpiece</label>
          <input
            id="Subpiece"
            type="text"
            placeholder="Give the subPiece a name"
          />
        </div>
      ...
      <div className="resultObj">
        <span>"Please send me a data:!!! "</span>
        <br />
        <p>{JSON.stringify(newObj)}</p>
        <ul>
          {operations.subPieces.map((e, index) => (
            <li key={index}>
              {e.name}---{e.index}
            </li>
          ))}
